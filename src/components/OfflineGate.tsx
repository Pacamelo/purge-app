 ...
 *
 * Wraps the PURGE module and encourages offline-only usage.
 ...
 * - When offline: Renders children (the actual PURGE UI)
...
/**
 * OfflineGate wraps PURGE and encourages offline-first usage for privacy
 *
...
export function OfflineGate({
  ...
  switch (offlineState.status) {
    ...
    case 'complete':
      return (
        <>
          {/* Show the complete UI (OutputBin) behind the countdown overlay */}
    ...
    case 'awaiting_download':
      ...
      // Just render children (OutputBin) - no overlay needed
